...
namespace ITnetworkProjekt.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InsuranceIds = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InsuredPersons_Email",
                table: "InsuredPersons",
                column: "Email",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_InsuredPersons_SocialSecurityNumber",
                table: "InsuredPersons",
